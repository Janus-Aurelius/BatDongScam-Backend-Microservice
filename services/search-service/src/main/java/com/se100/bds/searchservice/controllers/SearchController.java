package com.se100.bds.searchservice.controllers;

import com.se100.bds.searchservice.dtos.requests.AddSearchListRequest;
import com.se100.bds.searchservice.dtos.requests.AddSearchRequest;
import com.se100.bds.searchservice.dtos.responses.SingleResponse;
import com.se100.bds.searchservice.services.SearchService;
import com.se100.bds.searchservice.utils.Constants;
...
public class SearchController {
    ...
    public ResponseEntity<SingleResponse<String>> addSearch(@RequestBody AddSearchRequest request) {
    ...
    public ResponseEntity<SingleResponse<String>> addSearchList(@RequestBody AddSearchListRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.ACCEPTED).body(
                SingleResponse.<String>builder()
                        .statusCode(202)
                        .message("Search log batch accepted")
                        .data(null)
                        .build()
        );
    }
    ...
    public ResponseEntity<SingleResponse<List<UUID>>> topMostSearchByUser(
        ...
        return ResponseEntity.ok(
                SingleResponse.<List<UUID>>builder()
                        .statusCode(200)
    ...
    public ResponseEntity<SingleResponse<List<UUID>>> getMostSearchedPropertyIds(
            @Parameter(description = "Limit") @RequestParam(defaultValue = "10") int limit,
            @Parameter(description = "Year") @RequestParam int year,
            @Parameter(description = "Month") @RequestParam int month
    ) {
        ...
        return ResponseEntity.ok(
                SingleResponse.<List<UUID>>builder()
                        .statusCode(200)
                        .message("Most searched properties retrieved successfully")
                        .data(result)
                        .build()
        );
    }
